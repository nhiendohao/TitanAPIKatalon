...
WS.verifyElementPropertyValue(res_GetTransportOption, 'OptionType', 'OSB_TRANSPORT_OPTION_CAR')

//Verify Action
WS.verifyElementPropertyValue(res_GetTransportOption, 'OptionAvailabilityFlag', 'false')

//Verify Action
WS.verifyElementPropertyValue(res_GetTransportOption, 'OptionURL', 'null')

//Verify Action
WS.verifyElementPropertyValue(res_GetTransportOption, 'OptionURLLabel', 'null')

//Verify Action
WS.verifyElementPropertyValue(res_GetTransportOption, 'OptionPrice', '0')

//Verify Action
WS.verifyElementPropertyValue(res_GetTransportOption, 'POAFlag', 'false')
