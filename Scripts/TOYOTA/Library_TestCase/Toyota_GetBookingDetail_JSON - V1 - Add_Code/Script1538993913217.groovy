...
//All valid
	...
	WS.verifyElementPropertyValue(res_GetBookingDetail, 'RepairOrder.Services[0].Price', '110.0000')
		//Service 2
	WS.verifyElementPropertyValue(res_GetBookingDetail, 'RepairOrder.Services[1].Name', 'ADD_OP_CODE - Add Operation Code for Test')
	WS.verifyElementPropertyValue(res_GetBookingDetail, 'RepairOrder.Services[1].Description', 'null')
	...
	WS.verifyElementPropertyValue(res_GetBookingDetail, 'Contact[0].ToyotaContactID', '19011995')
	WS.verifyElementPropertyValue(res_GetBookingDetail, 'Contact[0].FirstName', 'QATEAM')
	WS.verifyElementPropertyValue(res_GetBookingDetail, 'Contact[0].LastName', 'VINHLE')
	...
	WS.verifyElementPropertyValue(res_GetBookingDetail, 'TransportOption', 'OSB_TRANSPORT_OPTION_WAIT')
