...
if(var_Status_OpCode.toString().toLowerCase() == "true"){
...
if(var_Status_GetOffTime.toString().toLowerCase() == "true"){
...
if(var_Status_PickupTime.toString().toLowerCase() == "true"){
...
if(var_Status_ReservedTimeslot.toString().toLowerCase() == "true"){
...
if(var_Status_GetTransport.toString().toLowerCase() == "true"){
...
if(var_Status_MakeBooking.toString().toLowerCase() == "true"){
...
if(var_Status_SearchBooking.toString().toLowerCase() == "true"){
...
if(var_Status_GetBookingDetail.toString().toLowerCase() == "true"){
...
//11. Cancel Booking
if(var_Status_CancelBooking.toString().toLowerCase() == "true"){
