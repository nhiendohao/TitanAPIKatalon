...
//Declare request
	RequestObject ROPost = findTestObject('Toyota_History/RepairOrderPost_JSON', [
...
//Declare response
	ResponseObject res_ROPost = WS.sendRequest(ROPost)
...
//All negative case
	...
	if(GlobalVariable.Glb_Booking_ID == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "repairOrderNumber [null]")
		println "Booking_ID = null"
	}
	//Miss ROStatus
	if(GlobalVariable.Glb_His_ROStatus == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "repairOrderStatus [null]")
		println "ROStatus = null"
	}
	//Miss VIN
	if(GlobalVariable.Glb_VIN == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "VIN [null]")
		println "VIN = null"
	}
	//Miss REGNumber
	if(GlobalVariable.Glb_REGNumber == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "Registration [null]")
		println "REGNumber = null"
	}
	//Miss REGState
	if(GlobalVariable.Glb_His_REGState == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "State [null]")
		println "REGState = null"
	}
	//Miss mileage
	if(GlobalVariable.Glb_His_mileage == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "Milage [null]")
		println "mileage = null"
	}
	//Miss tmcaDealerCode
	if(GlobalVariable.Glb_His_tmcaDealerCode == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "tmcaDealerCode [null]")
		println "tmcaDealerCode = null"
	}
	//Miss DealerName
	if(GlobalVariable.Glb_His_DealerName == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "dealerName [null]")
		println "DealerName = null"
	}
	//Miss tmcaBranchCode
	if(GlobalVariable.Glb_His_tmcaBranchCode == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "tmcaBranchCode [null]")
		println "tmcaBranchCode = null"
	}
	//Miss BranchName
	if(GlobalVariable.Glb_His_BranchName == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "branchName [null]")
		println "BranchName = null"
	}
	//Miss DMS
	if(GlobalVariable.Glb_His_DMS == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "dms [null]")
		println "DMS = null"
	}
	//Miss ContactId
	if(GlobalVariable.Glb_ContactId == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "dmsCustId [null]")
		println "ContactId = null"
	}
	//Miss FirstName
	if(GlobalVariable.Glb_FirstName == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "firstName [null]")
		println "FirstName = null"
	}
	//Miss LastName
	if(GlobalVariable.Glb_LastName == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "lastName [null]")
		println "LastName = null"
	}
	//Miss MobileNumber
	if(GlobalVariable.Glb_His_MobileNumber == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "mobileNumber [null]")
		println "MobileNumber = null"
	}
	//Miss jobNumber
	if(GlobalVariable.Glb_His_jobNumber == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "jobNumber [null]")
		println "jobNumber = null"
	}
	//Miss jobCategory
	if(GlobalVariable.Glb_His_jobCategory == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "category [null]")
		println "jobCategory = null"
	}
	//Miss jobServiceType
	if(GlobalVariable.Glb_His_jobServiceType == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "serviceType [null]")
		println "jobServiceType = null"
	}
	//Miss CodeType
	if(GlobalVariable.Glb_His_CodeType == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "codeType [null]")
		println "CodeType = null"
	}
	//Miss jobCode
	if(GlobalVariable.Glb_His_jobCode == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "code [null]")
		println "jobCode = null"
	}
	//Miss jobStatus
	if(GlobalVariable.Glb_His_jobDescription == ''){
		CustomKeywords.'qaVinhLe.Library_Method_VinhLe.verifyResponseCode_Msg'(res_ROPost, 400, "description [null]")
