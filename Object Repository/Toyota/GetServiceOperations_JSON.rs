...
<WebServiceRequestEntity>
   ...
   <restUrl>http://hcm-dev-testing.titandms.net.au:55551/api/dealers/${Dealer_Code}/locations/${Location_Code}/serviceOperations?vehicle=${VIN}&amp;serviceType=${Service_Type}</restUrl>
