...
<WebServiceRequestEntity>
   ...
   <restUrl>http://hcm-dev-testing.titandms.net.au:55551/api/dealers/${Dealer_Code}/locations/${Location_Code}/pickUps?duration=${Duration_Time}&amp;date=${Service_Date}&amp;dropOff=${Drop_Off_Time}&amp;serviceBayType=${ServiceBay_Time}</restUrl>
